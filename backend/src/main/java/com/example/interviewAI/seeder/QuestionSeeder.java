...
public class QuestionSeeder implements CommandLineRunner {
    ...
    private void seedQuestions() {
        ...
        questionRepository.saveAll(Arrays.asList(twoSum, validParentheses, longestSubstring, shoppingCart, rateLimiter));
        log.info("Successfully seeded 5 questions to database: Two Sum, Valid Parentheses, Longest Substring, Shopping Cart Advanced, Rate Limiter");
    }
}
